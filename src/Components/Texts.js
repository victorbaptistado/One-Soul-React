...
Let's build your mindset now!
    ...
    /*
      const [countChapter1, setCountChapter1] = useState(1);
...
/*
  ...
  */
    ...
    /*
    let chapter1Filt = chapter1.filter(text => text.id === countChapter1) ; 
    ...
    useState(
    setFilt(
    chapter1Filt.map((text)=>
    <>
    <Body text={text} countChapter1={countChapter1} setCountChapter1={setCountChapter1} />
    </>)),[])
    ;*/
